...
/*Table structure for table `log_update_stock` */

DROP TABLE IF EXISTS `log_update_stock`;

CREATE TABLE `log_update_stock` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tgl` datetime DEFAULT NULL COMMENT 'Tgl.',
  `id_barang` int(11) DEFAULT NULL COMMENT 'ID Barang',
  `stock_awal` int(11) DEFAULT NULL COMMENT 'Stock Awal',
  `stock_update` int(11) DEFAULT NULL COMMENT 'Stock Update',
  `user_id` int(11) DEFAULT NULL COMMENT 'User ID',
  PRIMARY KEY (`id`)
